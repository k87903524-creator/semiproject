...
function appendComment(comment){
	...
	// 새 div 태그를 만듬(아직 화면에 없음)
	const div = document.createElement('div');
	div.className = 'comment-item';
	div.id='comment-' + comment.commentId; // id로 나주엥 찾아 삭제하기 위해
...
async function submitComment(){
	...
	/*
		...
		ex) {bodyId : 3, commentContent : '안녕'}
		-> {'bodyId' : '3', 'commentContent' : '안녕'}
	*/
...
// 댓글 삭제(AJAX)
// commentId - 삭제할 댓글 번호(detail.html에서 onclick으로 전달)
