...
//		로그인 회원 정보 - 수정/삭제 버튼, 댓글 입력 홈 폼 표시 여부
...
//	[수정 폼으로 이동] GET /board/update/1 (로그인 + 작성자)
...
//	URL을 작성해서 타고 들어가는 것 만으로도 삭제될 수 있어서 위험하다 
